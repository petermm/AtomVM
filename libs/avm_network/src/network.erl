...
%% access point (in using ap+sta mode), but should not cause an active connection to be lost.
%% Espressif's documentation recommends not exceeding 1500 ms per-channel scan times or network
%% connections may be lost, this is enforced as a hard limit. The return is a tuple
