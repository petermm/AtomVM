    ...
    GlobalContext *global)
{
    ...
    *count = 0;
    ...
    EtsMultimapNode *node;
    EtsStatus result = node_find(multimap, key, &node, global);
...
EtsStatus ets_multimap_remove_tuple(
    EtsMultimap *multimap,
    term tuple,
    GlobalContext *global)
{
